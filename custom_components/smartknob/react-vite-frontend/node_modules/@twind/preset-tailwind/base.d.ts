import { MaybeArray, BaseTheme, CSSProperties, Preset } from '@twind/core';
...
interface TailwindPresetBaseOptions {
 ...
 * @experimental
 */
declare function presetTailwindBase({ colors, disablePreflight, }?: TailwindPresetBaseOptions): Preset<TailwindTheme>;

export { Container, FontFamilyValue, FontSizeValue, TailwindPresetBaseOptions, TailwindTheme, presetTailwindBase as default };
