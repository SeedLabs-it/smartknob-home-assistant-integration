...
/**
 * @internal
 */ const escape = 'undefined' != typeof CSS && CSS.escape || // Simplified: escaping only special characters
...
/**
 * @group Class Name Generators
 */ const animation = /* #__PURE__ */ new Proxy(function animation(animation, waypoints) {
...
/** Allows to resolve theme values. */ const kAutocomplete = /* #__PURE__ */ Symbol();
/**
 * @group Configuration
 * @param param0
 * @returns
 ...
 * @param target
 * @returns
 */ function observe(tw$1 = tw, target = false) {
    if (target) {
 ...
 */ function getSheet(useDOMSheet, disableResume) {
    let sheet = virtual(!disableResume);
...
function resume(addClassName, insert) {
    ...
    if (RE.test(textContent)) {
        var match;
        let // 2. add all existing class attributes to the token/className cache
        // 3. parse SSR styles
        lastMatch;
 ...
 *
 * @group Style Injectors
 */ const keyframes = /* #__PURE__ */ function bind(thisArg) {
...
/** Used as prefix */ /**
   ...
   */ /**
 * @group Class Name Generators
 */ const style = (base, config)=>'function' == typeof base ? createStyle(config, base) : createStyle(base);
...
exports.colorFromTheme = colorFromTheme;
 ...
 * @group Class Name Generators
 * @param input
 */ function(strings, ...interpolations) {
...
exports.getAutocompleteProvider = /**
 * @internal
 * @param resolver
 * @returns
 */ function(resolver) {
 ...
 * @param config
 * @param isProduction
 */ function(config, isProduction = true) {
...
exports.match = /** The found theme value */ // indirection wrapper to remove autocomplete functions from production bundles
/**
 * @group Configuration
 * @param pattern
 */ /**
 ...
 * @param resolve
 * @param convert
 */ function(pattern, // eslint-disable-next-line @typescript-eslint/ban-types
resolve, convert) {
    return [
        pattern,
...
exports.matchColor = /** Theme section to use (default: `$0.replace('-', 'Color')` — The matched string with `Color` appended) */ /** The css property (default: value of {@link section}) */ /** `--tw-${$0}opacity` -> '--tw-text-opacity' */ /** `section.replace('Color', 'Opacity')` -> 'textOpacity' */ /**
 * @group Configuration
 * @param pattern
 * @param options
 * @param resolve
 * @returns
 */ function(pattern, options = {}, resolve) {
    return [
        pattern,
 ...
 * @param convert
 * @returns
 */ function(pattern, /** Theme section to use (default: `$1` — The first matched group) */ section, /** The css property (default: value of {@link section}) */ resolve, convert) {
    return [
        pattern,
...
exports.withAutocomplete = /**
 * @experimental
 * @group Configuration
 * @param resolver
 * @param autocomplete
 */ function(rule, autocomplete) {
    // [
