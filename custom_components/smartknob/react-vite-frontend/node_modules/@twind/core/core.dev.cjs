...
/** Allows to resolve theme values. */ const kAutocomplete = /* #__PURE__ */ Symbol('@twind/autocomplete');
/**
 * @experimental
 * @group Configuration
 * @param resolver
...
function warn(message, code, detail) {
    ...
    } else 'function' == typeof process.emitWarning ? // Node.JS
 ...
 * @param config
 * @param isProduction
 */ function(config, isProduction = false) {
...
//# sourceMappingURL=core.dev.cjs.map
