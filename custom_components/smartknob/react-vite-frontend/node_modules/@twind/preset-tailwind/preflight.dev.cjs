'use strict';
const baseTheme = require('./baseTheme.dev.cjs'), preflight = {
    /*
    ...
    */ html: {
        ...
        /* 2 */ MozTabSize: '4',
        /* 3 */ tabSize: 4,
        /* 3 */ fontFamily: `theme(fontFamily.sans, ${baseTheme.fontFamily.sans})`,
    ...
    */ 'code,kbd,samp,pre': {
        fontFamily: `theme(fontFamily.mono, ${baseTheme.fontFamily.mono})`,
...
//# sourceMappingURL=preflight.dev.cjs.map
