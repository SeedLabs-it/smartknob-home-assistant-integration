!(function (t) {
  ...
  class m extends HTMLElement {
    ...
    requestUpdate(t, e, s) {
      let i = !0;
      void 0 !== t &&
        (((s = s || this.constructor.getPropertyOptions(t)).hasChanged || g)(
          this[t],
          e,
        )
  ...
  const W = (t, e) => {
    ...
    for (let e = 0; e < s; e++) {
      ...
      let a,
        ...
        d = -1,
        h = 0;
      for (; h < s.length && ((o.lastIndex = h), (l = o.exec(s)), null !== l); )
        (h = o.lastIndex),
          o === V
            ? '!--' === l[1]
              ? (o = O)
      ...
      r +=
        o === V
          ? s + k
          : d >= 0
          ? (i.push(a), s.slice(0, d) + '$lit$' + s.slice(d) + E + p)
          : s + E + (-2 === d ? (i.push(void 0), e) : p);
    }
        ...
        if (1 === i.nodeType) {
          if (i.hasAttributes()) {
            ...
            for (const e of i.getAttributeNames())
              if (e.endsWith('$lit$') || e.startsWith(E)) {
                const s = d[r++];
    ...
    return (
      (null == l ? void 0 : l.constructor) !== d &&
        (null === (r = null == l ? void 0 : l._$AO) ||
          void 0 === r ||
          r.call(l, !1),
        void 0 === d ? (l = void 0) : ((l = new d(t)), l._$AT(t, s, i)),
        void 0 !== i
          ? ((null !== (o = (a = s)._$Co) && void 0 !== o ? o : (a._$Co = []))[
              i
            ] = l)
          : (s._$Cl = l)),
  ...
  class J {
      ...
      const { values: s, _$litType$: i } = t,
        n =
          'number' == typeof i
            ? this._$AC(t)
            : (void 0 === i.el &&
                (i.el = Z.createElement(z(i.h, i.h[0]), this.options)),
              i);
    ...
    T(t) {
      ...
      for (const n of t)
        i === e.length
          ? e.push((s = new J(this.k(H()), this.k(H()), this, this.options)))
          : (s = e[i]),
          s._$AI(n),
          i++;
    ...
    _$AI(t, e = this, s, i) {
      ...
      if (void 0 === n)
        ...
        for (t = n[0], o = 0; o < n.length - 1; o++)
          (a = K(this, i[s + o], e, o)),
            a === D && (a = this._$AH[o]),
            r || (r = !C(a) || a !== this._$AH[o]),
            a === I
              ? (t = I)
              : t !== I && (t += (null != a ? a : '') + n[o + 1]),
            (this._$AH[o] = a);
      }
      r && !i && this.j(t);
    }
  ...
  class tt extends F {
    ...
    _$AI(t, e = this) {
      var s;
      if ((t = null !== (s = K(this, t, e, 0)) && void 0 !== s ? s : I) === D)
        return;
      const i = this._$AH,
        n =
          (t === I && i !== I) ||
  ...
  null == st || st(Z, J),
    (null !== (f = b.litHtmlVersions) && void 0 !== f
      ? f
      : (b.litHtmlVersions = [])
    ).push('2.8.0');
  /**
   ...
   */
  var pt;
  null === (pt = window.HTMLSlotElement) ||
    void 0 === pt ||
    pt.prototype.assignedElements;
  ...
  let ut = class extends rt {
        ...
        return j`<sk-reorderable-list-item
          ...
          @delete="${() => {
            (this.apps = this.apps.filter(
              (t) => t.app.app_id !== e.app.app_id,
            )),
              ct(
                this.hass,
                this.mac_address,
                this.apps.map((t) => t.app),
              ),
              this.requestUpdate();
          }}"
        >
          <div class="list-item">
            ...
            <ha-selector
              ...
              .selector="${{
                entity: {
                  include_entities: this.entities.map((t) =>
                    t.entity_id.startsWith(e.app_slug.domain)
                      ? t.entity_id
                      : '',
                  ),
                },
              ...
              .required=${
                'stopwatch' !=
                (null === (i = e.app_slug) || void 0 === i ? void 0 : i.slug)
              }
              .disabled=${(() => {
                var t;
                return (
                  'stopwatch' ==
                  (null === (t = e.app_slug) || void 0 === t ? void 0 : t.slug)
                );
              })()}
              .value=${
                null === (n = e.entity) || void 0 === n ? void 0 : n.entity_id
              }
            ></ha-selector>
          </div>
    ...
    drop(t) {
      ...
      (this.apps = this.reorderItems(this.apps, s, i)),
        ct(
          this.hass,
          this.mac_address,
          this.apps.map((t) => t.app),
  ...
  `),
    ...
    (ut = e([at('sk-reorderable-list')], ut));
    ...
    dragStart(t) {
      ...
      (this.style.opacity = '0.4'),
        null === (e = t.dataTransfer) ||
          void 0 === e ||
          e.setData('text/plain', this.id),
        (t.dataTransfer.effectAllowed = 'move'),
        this.classList.add('draggable-content'),
        t.target.classList.add('over');
    }
    dragEnter(t) {
  ...
  `),
    e([dt()], vt.prototype, 'app_id', void 0),
    e(
      [
        dt({
          type: Boolean,
    ...
    (vt = e([at('sk-reorderable-list-item')], vt));
  let _t = class extends rt {
    constructor() {
      super(...arguments),
        ...
        (this.handleSubmit = (t) => {
          ...
          const s = {
            app: {
              ...
              friendly_name: this._selectedEntity
                ? null !==
                    (e = this._selectedEntity.attributes.friendly_name) &&
                  void 0 !== e
                  ? e
                  : ''
          ...
          this.apps.find(
            (t) => t.app_slug == s.app_slug && t.entity == s.entity,
          ) || this.apps.push(s),
            (this.apps = [...this.apps]),
            (async (t, e, s) => {
            ...
            })(this.hass, this.mac_address, s.app),
            this.requestUpdate();
        });
    }
    connectedCallback() {
    ...
    render() {
        ...
        n = {
          entity: {
            include_entities: this.entities
              .map((t) =>
                !t.entity_id.startsWith(this._domain) ||
                this.apps.find((e) => {
                  var s;
                  return (
                    (null === (s = this._selectedSlug) || void 0 === s
                      ? void 0
                      : s.slug) == e.app.app_slug &&
                    e.app.entity_id == t.entity_id
                  );
                })
                  ? ''
                  : t.entity_id,
      ...
      <form class="add-app" @submit=${this.handleSubmit}>
        <ha-selector
          ...
          .label=${'Select App'}
          .value=${
            null === (t = this._selectedSlug) || void 0 === t ? void 0 : t.slug
          }
        ...
        <ha-selector
          ...
          .required=${
            'stopwatch' !=
            (null === (e = this._selectedSlug) || void 0 === e
              ? void 0
              : e.slug)
          }
          .disabled=${(() => {
            ...
            return (
              'stopwatch' ==
              (null === (t = this._selectedSlug) || void 0 === t
                ? void 0
                : t.slug)
            );
          })()}
          .value=${
            null === (s = this._selectedEntity) || void 0 === s
              ? void 0
    ...
    appSlugChanged(t) {
      ...
      (this._selectedSlug =
        null !== (e = this.appSlugs.find((e) => e.slug == t.detail.value)) &&
        void 0 !== e
          ? e
          : null),
        (this._domain =
    ...
    entityChanged(t) {
      ...
      this._selectedEntity =
        null !==
          (e = Object.values(this.hass.states).find(
            (e) => e.entity_id == t.detail.value,
          )) && void 0 !== e
          ? e
          : null;
    }
  ...
  `),
    ...
    e([ht()], _t.prototype, '_selectedSlug', void 0),
    e([ht()], _t.prototype, '_selectedEntity', void 0),
    e([ht()], _t.prototype, '_domain', void 0),
    e([ht()], _t.prototype, '_sortable', void 0),
    (_t = e([at('app-form')], _t));
  const gt = [
    {
      tabId: 'setup',
  ...
  (t.SmartknobPanel = class extends rt {
    ...
    async connectedCallback() {
      ...
      const s = (
          await (async (t) => {
            ...
            return (
              1 != e.success && console.log("ERROR: Couldn't get knobs"), e
            );
          })(this.hass)
        ).knobs,
        i = (
          await (async (t) => {
            ...
            return (
              'success' != e.success &&
                console.log("ERROR: Couldn't get app slugs"),
              e
            );
          })(this.hass)
        ).app_slugs,
        n = [];
      for (const r in s)
        for (const o of s[r].apps) {
          const s =
              null !== (t = i.find((t) => t.slug == o.app_slug)) && void 0 !== t
                ? t
                : i[0],
            r =
              null !==
                (e = [...Object.values(this.hass.states)].find(
                  (t) => t.entity_id == o.entity_id,
                )) && void 0 !== e
                ? e
                : null;
          n.push({
    ...
    render() {
      ...
      <div>
        <div class="header">
          ...
          >
            ${gt.map(
              (t) => j`<paper-tab tab-name=${t.tabId}
                  >${t.tabName}</paper-tab
                >`,
            )}
          </ha-tabs>
    ...
    handleTabSelect(t) {
      ...
      s.endsWith(e)
        ? this.scrollTo(0, 0)
        : (history.replaceState(null, '', `${s}/smartknob/${e}`),
          this.requestUpdate());
    }
  }),
  ...
  `),
    ...
    e([ht()], t.SmartknobPanel.prototype, '_appSlugs', void 0),
    e([ht()], t.SmartknobPanel.prototype, '_appList', void 0),
    e([ht()], t.SmartknobPanel.prototype, '_knobs', void 0),
    e([ht()], t.SmartknobPanel.prototype, '_currentTab', void 0),
    (t.SmartknobPanel = e([at('smartknob-panel')], t.SmartknobPanel));
})({});
